...
for psi in range(0,len(ps)):
    ...
    joblib.dump(robust_scaler, base_path + 'data/' + str(nr) + '/rs-' + algorithm + '-' + str(ps[psi]) + '.pkl')    
    ...
    if classifier is not None or exists_be_file is True:
        ...
        if cv is True:
            ...
            # save best estimator
            joblib.dump(gs.best_estimator_, base_path + 'data/' + str(nr) + '/best-estimator-' + algorithm + '-' + str(ps[psi]) + '.pkl')   
        ...
        #save classifier 
        joblib.dump(classifier, base_path + 'data/' + str(nr) + '/' + algorithm + '-' + str(ps[psi]) + '.pkl')  
    
        # store classes
        ordered_y = sorted(set(Y_train))
        
        
        joblib.dump(ordered_y, base_path + 'data/' + str(nr) + '/classes-' + algorithm + '-' + str(ps[psi]) + '.pkl')    
        ...
        out_file = open(base_path + "data/" + str(nr) + "/test-" + algorithm + '-' + str(ps[psi]) + '.txt',"w")
