...
class MyAPI:
    ...
    lf = [
        ...
        'row',
        'col',
        'EXTRACT(DOY FROM date_time)',
        'EXTRACT(HOUR FROM date_time)*60 + EXTRACT(MINUTE FROM date_time)'
    ]
    ...
    features = [
        ...
        #'discretized_course',
        'basic_class',
        'EXTRACT(DOY FROM date_time)', # day of year
        'EXTRACT(HOUR FROM date_time)*60 + EXTRACT(MINUTE FROM date_time)' # minutes from midnight
    ]
