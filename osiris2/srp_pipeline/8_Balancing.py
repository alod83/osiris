...
# 
# **INPUT**
# * `resources/dataset_60.csv`
# 
# **OUTPUT**
# * `resources/X_balanced_60.csv`
# * `resources/y_balanced_60.csv`
...
X_res.to_csv('resources/X_balanced_60.csv')
y_res.to_csv('resources/y_balanced_60.csv')
